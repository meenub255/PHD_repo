      ...
      <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .objective-cell {
          ...
          position: relative;
          overflow: hidden;
          transition: border-color 0.3s, box-shadow 0.3s, transform 0.35s cubic-bezier(.4,0,.2,1);
        }
        .objective-cell:hover {
          border-color: var(--orange);
          box-shadow: 0 8px 32px rgba(255,140,0,0.18), 0 2px 8px rgba(0,0,0,0.06);
        ...
        @keyframes workflowPulse {
          ...
          50% { box-shadow: 0 0 20px 2px rgba(255,140,0,0.2); }
        }
        ...
        @media (max-width: 640px) { .objectives-table { grid-template-columns: 1fr; max-width: 100%; } }
      </style>
    </head>
    <body>
      <div class="page">
        <h1>Intelligence Perception for Autonomous Vehicles using Monocular Vision and Deep Learning Techniques</h1>
        ...
        <div class="main-layout">
          <div class="objectives-table">
            <div class="objective-cell" onclick="window.location.href='{{ url_for('objective1') }}'">
              ...
              <div class="steps-toggle">Open Pipeline &rarr;</div>
            </div>
          ...
          <div class="video-panel">
            <video autoplay muted loop playsinline style="width:100%;height:auto;display:block;border-radius:14px;">
              <source src="{{ url_for('demo_video') }}" type="video/mp4">
            </video>
          </div>
        </div>
      </div>
